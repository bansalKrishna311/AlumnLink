...
const SignUpPage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen lg:h-[95vh] p-2 w-full lg:w-[52vw] m-auto lg:ps-2 my-4 rounded-bl-[110px] rounded-tl-[10px] rounded-tr-[10px] rounded-br-[10px] shadow-lg bg-white">
          ...
          <div className="w-full">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#CF9400]" />
                <input
                  type="text"
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#CF9400]" />
                <input
                  type="email"
                  placeholder="Email"
                  value={email}
              ...
              <div className="relative">
                <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#CF9400]" />
                <select
                  value={location}
