...
const Footer = () => {
  const navigationLinks = [
    ...
    { 
      ...
      href: '/landing/institutes',
      subItems: [
        { label: 'For Corporates', href: '/landing/corporates' },
        { label: 'For Schools', href: '/landing/schools' },
        { label: 'For Alumni', href: '/landing/alumni' }
      ]
    },
    { label: 'FAQs', href: '/landing/faqs' },
