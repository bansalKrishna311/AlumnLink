...
const CorporateList = () => {
  ...
  const handleUpdateCorporate = (updatedCorporate) => {
    setCorporates(prev => prev.map(corporate => 
      corporate._id === updatedCorporate._id ? updatedCorporate : corporate
    ));
  };
  ...
  return (
    <>
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-gray-2 text-left dark:bg-meta-4">
                ...
                <th className="min-w-[180px] py-4 px-4 font-medium text-black">
                  Assigned Courses
                </th>
                ...
                <tr key={index}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4">
                    <div className="flex flex-wrap gap-1">
                      {corporate.assignedCourses && corporate.assignedCourses.length > 0 ? (
                        corporate.assignedCourses.slice(0, 2).map((course, idx) => (
                          <span 
                            key={idx}
                      ...
                      {corporate.assignedCourses && corporate.assignedCourses.length > 2 && (
                        <span className="px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">
                          +{corporate.assignedCourses.length - 2} more
                        </span>
                      )}
                    </div>
                  </td>
                  <td className="border-b border-[#eee] py-5 px-4">
                    <div className="flex items-center space-x-3.5">
                      <button 
                        ...
                        className="hover:text-primary flex items-center gap-1 px-3 py-1 bg-blue-50 text-blue-600 rounded-md hover:bg-blue-100 transition-colors"
      ...
      <EditAdminModal
        ...
        admin={editingCorporate}
        onUpdate={handleUpdateCorporate}
        adminType="Corporate"
      />
    </>
  );
