...
import ForgotPasswordImage from "../../assets/login.png"; // Adjust this import to the actual path of your image
import icon from "../../assets/login-icon.webp"; // Adjust this import to the actual path of your icon
