...
const InstituteList = () => {
  ...
  const handleUpdateInstitute = (updatedInstitute) => {
                ...
                <tr key={index}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4">
                    <div className="flex flex-wrap gap-1">
                      {institute.assignedCourses && institute.assignedCourses.length > 0 ? (
                        institute.assignedCourses.slice(0, 2).map((course, idx) => (
                          <span 
                            key={idx}
                      ...
                      {institute.assignedCourses && institute.assignedCourses.length > 2 && (
                        <span className="px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">
                          +{institute.assignedCourses.length - 2} more
                        </span>
                      )}
                    </div>
                  </td>
