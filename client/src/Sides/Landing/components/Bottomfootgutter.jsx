  ...
  return (
    <div>
      <footer className="footer bg-base-200 text-base-content p-10 flex flex-col items-center md:flex-row md:justify-between md:items-start md:px-10">
        ...
        {/* Updated nav items to have left-aligned titles for medium and large screens */}
        <div className="flex flex-col items-center md:flex-row md:ml-auto md:space-x-10 md:justify-end md:mb-0">
